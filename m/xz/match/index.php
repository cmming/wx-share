...
//微信定制分享的变量
$share_title = "十万大奖寻新洲麻神";
$share_desc = "新洲第一届汽车杯麻将竞技大赛开幕！手机即可参加，寻新洲麻神称号！";
$share_link = $url;
...
<head>
    ...
    <title>十万大奖寻新洲麻神</title>
	<meta name="keywords" content="">
	<meta name="description" content="新洲第一届汽车杯麻将竞技大赛开幕！手机即可参加，寻新洲麻神称号！">
        ...
        <div class="swiper-wrapper">
            ...
            <section class="swiper-slide page3">
                ...
                <div class="ani  animated" swiper-animate-effect="bounceInUp" swiper-animate-duration="1s" swiper-animate-delay="1s"
                    ...
                    <img src="./images/03/prifont.png" alt="">
                </div>
            ...
            <section class="swiper-slide page4">
                ...
                <div class="ani  animated" swiper-animate-effect="bounceInUp" swiper-animate-duration="1s" swiper-animate-delay="1s"
                    style="left: 10.5%; top: 33.9%;width: 79%;height: 40.8%">
                ...
                <div class="ani  animated" swiper-animate-effect="bounceInUp" swiper-animate-duration="1s" swiper-animate-delay="1s"
                    ...
                    width: 30%;
                    height: 6%;">
                    <img onclick="window.location.href='./game_detail.html'" src="./images/04-05/btnDetail.png" alt="">      
                </div>
            </section>
            ...
            <section class="swiper-slide page9">
                <div class="ani  animated" swiper-animate-effect="bounceInDown" swiper-animate-duration="1s" swiper-animate-delay="0s"
                    ...
                    <img onclick="window.location.href='http://s0.lgyouxi.cn/h5_xzmj/port/download.php'" src="./images/09/btn.png" alt="">
                </div>
            </section>
        </div>
        <!-- 如果需要分页器 -->
